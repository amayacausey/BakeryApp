...
public class BakeryDatabase{
    ...
    public void preloadDB(){
        Bakery itemOne =  new Bakery("Reece's Peanut Cookie", 9.99, "Jan 23", "peanuts ","soy", 10);
        Bakery itemTwo =  new Bakery("Vegan Vanilla Pudding", 4.99, "Jan 23", "soy", "soy",5);
        Bakery itemThree =  new Bakery("Chocolate Cake", 4.99, "Jan 23", "gluten","gluten", 7);
        Bakery itemFour =  new Bakery("Peanut Brittle", 7.99, "Jan 23", "peanuts", "peanuts",8);
        Bakery itemFive =  new Bakery("Banana Pudding", 8.99, "Jan 23", "dairy", "dairy",7);
        Bakery itemSix =  new Bakery("Cookies & Cream Ice Cream", 4, "Jan 23", "dairy", "dairy",5);
        Bakery itemSeven =  new Bakery("Tofu Donut", 5, "Jan 23", "soy","soy", 5);
        Bakery itemEight =  new Bakery("Mango Pudding", 10.99, "Jan 23", "soy","soy", 6);
        Bakery itemNine =  new Bakery("Peanutbutter Cake", 7.99, "Jan 23", "peanuts","peanuts", 3);
        Bakery itemTen =  new Bakery("Apple Pie", 12.99, "Jan 23", "gluten","gluten", 10);
        Bakery itemEleven =  new Bakery("Vegan Pumpkin Pie", 8.99, "Jan 23", "soy", "soy",4);
        Bakery itemTwelve =  new Bakery("Blueberry Muffin", 2.99, "Jan 23", "gluten", "gluten",12);
        Bakery itemThirteen =  new Bakery("Strawberry Cheesecake", 4.99, "Jan 23", "dairy","dairy", 3);
        Bakery itemFourteen =  new Bakery("Vanilla Blast", 8.99, "Jan 23", "dairy","dairy", 10);
        Bakery itemFifteen =  new Bakery("Glazed Donut", 1.99, "Jan 23", "gluten","gluten" ,12);
...
//            }
    ...
    public  String searchByAllergy(String userAllergy){
        ...
        for (Bakery item : this.bakeryDatabase){
            // compare userAllegy with each item's allergy
            // if found
            //then add productname to retval
            if(userAllergy.contains(item.getAllergy())||userAllergy.contains(item.getAllergy2())){
                retval += item.getProductName() + " ";
            }
            else if (userAllergy.equalsIgnoreCase("all")) {
                retval += item.getProductName() + " ";
            }
