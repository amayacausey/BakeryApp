...
public class BakeryDatabase{
    ...
    public void preloadDB(){
        Bakery itemOne =  new Bakery("Reece's Peanut Cookie", 9.99, "Jan 23", "peanuts", 10);
        Bakery itemTwo =  new Bakery("Vegan Vanilla Pudding", 4.99, "Jan 23", "soy", 5);
        Bakery itemThree =  new Bakery("Chocolate Cake", 4.99, "Jan 23", "gluten", 7);
        Bakery itemFour =  new Bakery("Peanut Brittle", 7.99, "Jan 23", "peanuts", 8);
        Bakery itemFive =  new Bakery("Banana Pudding", 8.99, "Jan 23", "dairy", 7);
        ...
        Bakery itemNine =  new Bakery("Peanutbutter Cake", 7.99, "Jan 23", "peanuts", 3);
...
//            }
        ...
        public  String searchByAllergy(String userAllergy){
           ...
           for (Bakery item : this.bakeryDatabase){
               ...
               if(userAllergy.equalsIgnoreCase(item.getAllergy())){
